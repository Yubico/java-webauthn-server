...
import static com.yubico.u2f.testdata.TestVectors.CLIENT_DATA_SIGN_BASE64;
...
import static com.yubico.u2f.testdata.TestVectors.REGISTRATION_DATA_WITH_DIFFERENT_APP_ID_BASE64;
import static com.yubico.u2f.testdata.TestVectors.REGISTRATION_DATA_WITH_DIFFERENT_CLIENT_DATA_TYPE_BASE64;
...
import static com.yubico.u2f.testdata.TestVectors.SIGN_RESPONSE_INVALID_USER_PRESENCE_BASE64;
import static com.yubico.u2f.testdata.TestVectors.TRUSTED_DOMAINS;
import static com.yubico.u2f.testdata.TestVectors.USER_PUBLIC_KEY_SIGN_HEX;
...
public class U2fPrimitivesTest {
    ...
    public void finishRegistration() throws Exception {
        ...
        DeviceRegistration response = u2f.finishRegistration(registerRequest, new RegisterResponse(REGISTRATION_DATA_BASE64, CLIENT_DATA_REGISTRATION_BASE64), TRUSTED_DOMAINS);
    ...
    public void finishRegistrationShouldDetectIncorrectAppId() throws Exception {
        ...
        DeviceRegistration response = u2f.finishRegistration(
            registerRequest,
            new RegisterResponse(
                REGISTRATION_DATA_WITH_DIFFERENT_APP_ID_BASE64,
                CLIENT_DATA_REGISTRATION_BASE64
            )
        );
