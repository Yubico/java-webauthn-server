...
final public class TestVectors {
    ...
    public static final String CLIENT_DATA_SIGN = String.format(
            ...
            CHANNEL_ID_STRING,
            ORIGIN);
    public static final ByteArray CLIENT_DATA_SIGN_SHA256 = fromHex(
            "ccd6ee2e47baef244d49a222db496bad0ef5b6f93aa7cc4d30c4821b3b9dbc57");
    public static final ByteArray REGISTRATION_REQUEST_DATA = fromHex(
    ...
    public static final ByteArray REGISTRATION_RESPONSE_DATA = fromHex(
    ...
    public static final ByteArray REGISTRATION_RESPONSE_DATA_WITH_DIFFERENT_APP_ID = fromHex(
                "0504b174bc49c7ca254b70d2e5c207cee9cf174820ebd77ea3c65508c26da51b"
                    + "657c1cc6b952f8621697936482da0a6d3d3826a59095daf6cd7c03e2e60385d2"
                    + "f6d9402a552dfdb7477ed65fd84133f86196010b2215b57da75d315b7b9e8fe2"
                    + "e3925a6019551bab61d16591659cbaf00b4950f7abfe6660e2e006f76868b772"
    ...
    public static final ByteArray REGISTRATION_RESPONSE_DATA_WITH_DIFFERENT_CLIENT_DATA_TYPE = fromHex(
        "0504b174bc49c7ca254b70d2e5c207cee9cf174820ebd77ea3c65508c26da51b"
            + "657c1cc6b952f8621697936482da0a6d3d3826a59095daf6cd7c03e2e60385d2"
            + "f6d9402a552dfdb7477ed65fd84133f86196010b2215b57da75d315b7b9e8fe2"
            + "e3925a6019551bab61d16591659cbaf00b4950f7abfe6660e2e006f76868b772"
    ...
    public static final ByteArray KEY_HANDLE = fromHex(
    ...
    public static final ByteArray USER_PUBLIC_KEY_REGISTER_HEX = fromHex(
            "04b174bc49c7ca254b70d2e5c207cee9cf174820ebd77ea3c65508c26da51b65"
                    ...
                    + "d9");
    public static final ByteArray SIGN_RESPONSE_DATA = fromHex(
    ...
    public static final ByteArray EXPECTED_REGISTER_SIGNED_BYTES = fromHex(
            "00f0e6a6a97042a4f1f1c87f5f7d44315b2d852c2df5c7991cc66241bf7072d1"
                    ...
                    + "657c1cc6b952f8621697936482da0a6d3d3826a59095daf6cd7c03e2e60385d2"
                    + "f6d9");
    public static final ByteArray EXPECTED_SIGN_SIGNED_BYTES = fromHex(
            "4b0be934baebb5d12d26011b69227fa5e86df94e7d94aa2949a89f2d493992ca"
                    ...
                    + "1b3b9dbc57");
    public static final ByteArray SIGNATURE_REGISTER = fromHex(
            "304502201471899bcc3987e62e8202c9b39c33c19033f7340352dba80fcab017"
                    ...
                    + "a6d3d3961ef871");
    public static final ByteArray SIGNATURE_SIGN = fromHex(
    ...
    public static final ByteArray SIGN_RESPONSE_INVALID_USER_PRESENCE = fromHex(
    ...
    private static ByteArray fromHex(String hex) {
        try {
