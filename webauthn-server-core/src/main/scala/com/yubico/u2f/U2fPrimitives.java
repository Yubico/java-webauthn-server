...
public class U2fPrimitives {
    ...
    /**
     * @see U2fPrimitives#finishRegistration(RegisterRequest, RegisterResponse, java.util.Set)
     */
     ...
     *
     * @see U2fPrimitives#startSignature(String, DeviceRegistration, byte[])
     */
    ...
    /**
     * @see U2fPrimitives#finishSignature(SignRequest, SignResponse, DeviceRegistration, java.util.Set)
     */
