...
![Build Status](https://travis-ci.org/Yubico/java-u2flib-server.svg?branch=master)
![Coverage Status](https://coveralls.io/repos/github/Yubico/java-u2flib-server/badge.svg)
