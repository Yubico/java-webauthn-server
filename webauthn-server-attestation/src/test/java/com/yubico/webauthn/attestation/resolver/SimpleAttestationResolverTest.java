...
public class SimpleAttestationResolverTest {
    ...
    public void testResolve() throws Exception {
        final SimpleAttestationResolver resolver = SimpleAttestationResolver.fromMetadataJson(METADATA_JSON);
        Attestation metadata = resolver.resolve(attestationCertificate, Optional.of(trustedCertificate)).orElse(null);
    ...
    public void resolveReturnsEmptyOnUntrustedSignature() throws Exception {
        final SimpleAttestationResolver resolver = new SimpleAttestationResolver(Collections.emptyList());

        assertEquals(Optional.empty(), resolver.resolve(attestationCertificate, Optional.of(trustedCertificate)));
    }
